...
export const metadata: Metadata = {
  ...
  description: 'Leading manufacturer of sanitary and plastic materials with over 35 years of experience. Quality products for residential and commercial use.',
